...
import { IProductOfferPatch } from '../db/trading/models/ProductOffer';
import { LeanProductCategory } from "../db/trading/models/ProductCategory";

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type PatchOfferRequest<P extends core.Params = core.ParamsDictionary, ResBody = any, ReqBody = IProductOfferPatch, ReqQuery = core.Query> = core.Request<P, ResBody, ReqBody, ReqQuery>
